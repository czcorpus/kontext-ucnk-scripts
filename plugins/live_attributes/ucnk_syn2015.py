...
ITEM_COLS = [
    ...
    ('doc_id',  unicode),
    ('doc_nazev',  unicode),
    ('doc_podtitul',  unicode),
    ('doc_autor',  unicode),
    ('doc_nakladatel',  unicode),
    ('doc_mistovyd',  unicode),
    ('doc_rokvyd',  unicode),
    ('doc_prvnivyd',  unicode),
    ...
    ('doc_genre',  unicode),
    ('doc_med',  unicode),
    ('doc_periodicita',  unicode),
    ('doc_vek_adresata', unicode),
    ('wordcount', int),
    ('poscount', int)
]
...
SCHEMA = (
    ...
    """CREATE VIEW bibliography as SELECT doc_id as id, doc_nazev, doc_podtitul, doc_autor, doc_nakladatel,
            doc_mistovyd, doc_rokvyd, doc_prvnivyd, doc_isbnissn, doc_preklad,
            doc_srclang, doc_txtype_group, doc_txtype, doc_genre_group,
            doc_genre, doc_med, doc_periodicita, doc_vek_adresata FROM item"""
)
